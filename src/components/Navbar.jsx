...
const Navbar = () => {
  ...
  return (
   ...
   {/* Menu */}
    ...
    {/* Mobile Menu */}
    <ul className={!nav ? 'hidden' :'absolute top-0 left-0 w-full h-screen bg-[#050c17] flex flex-col justify-center items-center'}>
    ...
    <div className='hidden lg:flex fixed flex-col top-[35%] left-0'>
      <ul>
        ...
        <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-gray-700'>
          <a className='flex justify-between items-center w-full text-gray-300' 
          href="https://github.com/mehulmittall">
        ...
        <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-green-800'>
          <a className='flex justify-between items-center w-full text-gray-300' 
          href="https://drive.google.com/file/d/1J5CtB5DvNBI-i1nR9yur2yu_ZA4k33Ez/view?usp=sharing">
